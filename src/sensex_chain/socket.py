...
class DataFeedError(RuntimeError):
    """Raised when the market-data socket cannot be started."""
...
class FyersDataFeed:
    ...
    def start(
        ...
        on_tick: Callable[[Mapping[str, object]], None],
    ) -> None:
        ...
        try:
            ...
            self._socket = None
            raise DataFeedError("FYERS market-data socket failed to start") from exc
